...
public class AuthorizationServerConfiguration {
    ...
    /**
     * AuthorizationServerConfiguration — for everything related to the OAuth2 authorization server
     */
...
//                .redirectUri("http://clientserver:9000/login/oauth2/code/demo-client")
//                .redirectUri("http://localhost:9000/login/oauth2/code/demo-client")
//                .redirectUri("http://localhost:3000/login/oauth2/code/demo-client")
                .redirectUri("http://localhost:4200/login/oauth2/code/demo-client")
